	...
	<form class="form-inline" method="POST" action="" id="employment">
		...
		<table class="table table-striped">
			<tr>
				...
				<td>
					<?php echo Form::select('contact_result', Input::post('contact_result', isset($post) ? $post->contact_result : isset($contact_result)? $contact_result:''), \Constants::$_contact_result, array('class'=>'form-control')); ?>
				</td>
			</tr>
			<tr>
				<th class="text-right">面接日</th>
				<td>
					<?php echo Form::input('review_date', Input::post('review_date', isset($post) ? $post->review_date :isset($review_date)? $review_date:''), array('class' => 'form-control dateform', 'size' => 12)); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<?php echo Form::select('review_result', Input::post('review_result', isset($post) ? $post->review_result :isset($review_result)? $review_result:''), \Constants::$_review_result, array('class'=>'form-control')); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<?php echo Form::select('classification', Input::post('classification', isset($post) ? $post->classification : isset($classification)? $classification:''), \Constants::$_classification, array('class'=>'form-control')); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<?php echo Form::select('adoption_result', Input::post('adoption_result', isset($post) ? $post->adoption_result :isset($adoption_result)? $adoption_result:''), \Constants::$_adoption_result, array('class'=>'form-control')); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<?php echo Form::input('registration_expiration', Input::post('registration_expiration', (isset($registration_expiration) ? $registration_expiration : (isset($reg_expiration) ? $reg_expiration : ''))), array('class' => 'form-control dateform', 'size' => '12')); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					<button type="button" class="btn btn-sm btn-success" name="get-code-btn">
						配属支店の最新社員コードをセット
					</button>
