...
<table class="table table-striped">
	...
	?>
	<tr>
		<th class="text-right">取引区分</th>
		<?php if(isset($partner)) {
            echo \Fuel\Core\Form::input('type',(isset($partner) ? $partner->type : ''),array('type' => 'hidden'));
        }
        ?>
	...
	<tr>
        <th class="text-right">
            取引先（法人）
            <button type="button" class="btn btn-sm btn-success" name="findgroup-btn">
                <i class="glyphicon glyphicon-search icon-white"></i>
            </button>
        </th>
        <td>
            <input type="hidden" name="m_group_id" value="<?php echo isset($partner) ? $partner->m_group_id : '';?>">
            <div id="group-name">
                <?php
                    $group_name = isset($partner) ? Model_Mgroups::find_by_pk($partner->m_group_id)->name : '※未選択';
                    echo $group_name;
                ?>

            </div>
            <label id="m_group_id-error" class="error" for="m_group_id"></label>
	...
	<tr>
		...
		<td>
			<?php echo Fuel\Core\Form::input('tel_1',isset($partner->tel) ? (substr_count($partner->tel, '-') ? explode('-', $partner->tel)[0] : substr($partner->tel,0,4)) : '',array('class'=>'form-control','size'=>'5', 'maxlength' => '5')); ?>
            -
	...
	<tr>
		...
		<td>
			<?php echo Fuel\Core\Form::input('fax_1',isset($partner->fax) ? (substr_count($partner->fax, '-') ? explode('-', $partner->fax)[0] : substr($partner->fax,0,4)) : '',array('class' => 'form-control', 'size' => '5', 'maxlength' => '5')); ?>
            -
...
<!-- MODAL SEARCH GROUP -->
<div id="groupfinder" class="modal fade">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">法人検索</h4>
            </div>
                ...
                <form mehod="get">
                    <div class="form-group">
                        ...
                        <div class="form-inline">
                            <input class="form-control modal_keyword" placeholder="法人名" type="text" size="100">
                            <button id="btn_group_search" type="button" class="btn btn-primary btn-sm">
                                <i class="glyphicon glyphicon-search icon-white"></i>
                            </button>
