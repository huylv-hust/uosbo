...
class Constants
{
    public static function keys2values($constants, $keysString, $delimiter = ',')
    {
        $values = [];
        foreach (explode(',', trim($keysString)) as $key) {
