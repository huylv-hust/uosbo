var groups = function(){
    ...
    var modal = function(groupid,groupname){
        ...
        strString += '<label class="col-md-2 control-label">グループ名</label>';
        strString += '<div class="col-md-10">';
        strString += '<input type="text" id="groupname" name="groupname" required value="'+groupname+'" class="form-control" placeholder="グループ名を入力" size="50">';
        strString += '<span class="text-info"></span>';
        strString += '</div>';
        strString += '</div>';
        strString += '<div class="form-group text-center">';
        strString += '<button type="button" id="groupsave" class="btn btn-primary btn-sm">';
